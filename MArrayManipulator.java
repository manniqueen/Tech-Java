...
public class MArrayManipulator {
        ...
        while (!"end".equals(input = scanner.nextLine())) {
            ...
            switch (command) {
                ...
                case "min":
                    ...
                    break;
                case "max":
                    maxElementIndex (numbers, data [1], "max");
                    break;
                case "first":
    ...
    private static void lastCountElements(int[] numbers, int count, String command) {
        ...
        int index =0;
        filElementByCriteria(numbers, count, num, index, "last");
    ...
    private static void firstCountElements(int[] numbers, int count, String command) {
        ...
        int num = command.equals("even") ? 0 : 1;
        int index =0;
        filElementByCriteria(numbers, count, num, index,"first");

    }

    private static void filElementByCriteria(int[] numbers, int count, int num, int index, String criteria) {
    ...
    private static void maxElementIndex(int[] numbers, String command, String condition) {
        int num = command.equalsIgnoreCase("even") ? 0 : 1;
